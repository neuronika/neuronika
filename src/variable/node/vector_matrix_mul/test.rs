use super::{
    ...
    Forward, Gradient, Overwrite, Tensor, VectorMatrixMul, VectorMatrixMulBackward,
...
mod forward {
    use super::{
        assert_almost_equals, new_input, new_tensor, Cache, Data, Forward, Tensor, VectorMatrixMul,
    };
